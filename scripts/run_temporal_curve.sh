...
python -B ./src/dd_temporal_order_plot.py synthetic-13-6-PS-0.300-0.60 --export pdf
...
python -B ./src/dd_temporal_order_plot.py synthetic-13-6-PS-0.600-0.60 --export pdf
